...
[Source](https://web.archive.org/web/20100726112636/http://wowprogramming.com/docs/events/CHAT_MSG_TEXT_EMOTE)

---

Fires when the player receives a standard emote (e.g. `/dance`, `/flirt`) message. For custom emote messages (those sent by typing `/emote` followed by some text), see [`CHAT_MSG_EMOTE`](CHAT_MSG_EMOTE.md).
