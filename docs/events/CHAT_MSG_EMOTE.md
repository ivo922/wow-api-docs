...
[Source](https://web.archive.org/web/20100726112636/http://wowprogramming.com/docs/events/CHAT_MSG_EMOTE)

---

Fires when a custom emote message is received.. Custom emote messages are those sent by typing `/emote` followed by some text; see [`CHAT_MSG_TEXT_EMOTE`](CHAT_MSG_TEXT_EMOTE.md) for standard emotes such as `/dance` and `/flirt`.
