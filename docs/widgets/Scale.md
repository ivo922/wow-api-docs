...
[Source](https://web.archive.org/web/20100726120937/http://wowprogramming.com/docs/widgets/Scale)
...
```lua
framerate = Scale:GetMaxFramerate()
```
...
- `point` - Anchor point for the scale origin (`string`, [anchorPoint](../types/anchorPoint.md))
...
```lua
Scale:SetMaxFramerate(framerate)
```
