...
[Source](https://web.archive.org/web/20100726120937/http://wowprogramming.com/docs/widgets/Alpha)
...
```lua
framerate = Alpha:GetMaxFramerate()
```
...
```lua
Alpha:SetMaxFramerate(framerate)
```
