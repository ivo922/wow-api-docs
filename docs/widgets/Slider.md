...
- `value` - Value representing the current position of the slider thumb (between `minValue` and `maxValue`, where `minValue, maxValue = slider`[`:GetMinMaxValues()`](Slider.md#slidergetminmaxvalues)) (`number`)
...
- `value` - Value representing the new position of the slider thumb (between `minValue` and `maxValue`, where `minValue, maxValue = slider`[`:GetMinMaxValues()`](Slider.md#slidergetminmaxvalues)) (`number`)
