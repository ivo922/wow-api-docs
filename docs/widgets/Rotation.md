...
[Source](https://web.archive.org/web/20100726120937/http://wowprogramming.com/docs/widgets/Rotation)
...
```lua
framerate = Rotation:GetMaxFramerate()
```
...
```lua
Rotation:SetMaxFramerate(framerate)
```
