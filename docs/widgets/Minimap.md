...
Returns the location of the last "ping" on the minimap. Coordinates are pixel distances relative to the center of the minimap (not fractions of the minimap's size as with [`:GetPingPosition()`](Minimap.md#minimapgetpingposition)); positive coordinates are above or to the right of the center, negative are below or to the left.
...
- `zoomLevel` - Index of the current zoom level (between 0 for the widest possible zoom and `(minimap:`[`GetZoomLevels()`](Minimap.md#minimapgetzoomlevels)`- 1)` for the narrowest possible zoom) (`number`)
...
"Pings" the minimap at a given location. Coordinates are pixel distances relative to the center of the minimap (not fractions of the minimap's size as with [`:GetPingPosition()`](Minimap.md#minimapgetpingposition)); positive coordinates are above or to the right of the center, negative are below or to the left.
...
- `zoomLevel` - Index of a zoom level (between 0 for the widest possible zoom and `(minimap:`[`GetZoomLevels()`](Minimap.md#minimapgetzoomlevels)`- 1)` for the narrowest possible zoom) (`number`)
