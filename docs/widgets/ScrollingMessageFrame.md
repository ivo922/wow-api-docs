...
- `id` - Identifier for the message's type (see [`:UpdateColorByID()`](https://web.archive.org/web/20100726112636/http://wowprogramming.com/docs/widgets/ScrollingMessageFrame/UpdateColorByID)) (`number`)
- `addToTop` - True to insert the message above all others listed in the frame, even if the frame's [insert mode](https://web.archive.org/web/20100726112636/http://wowprogramming.com/docs/widgets/ScrollingMessageFrame/SetInsertMode) is set to `BOTTOM`; false to insert according to the frame's insert mode (`boolean`)
...
Returns the duration of the fade-out animation for disappearing messages. For the amount of time a message remains in the frame before beginning to fade, see [`:GetTimeVisible()`](https://web.archive.org/web/20100726112636/http://wowprogramming.com/docs/widgets/ScrollingMessageFrame/GetTimeVisible).
...
Sets the duration of the fade-out animation for disappearing messages. For the amount of time a message remains in the frame before beginning to fade, see [`:SetTimeVisible()`](https://web.archive.org/web/20100726112636/http://wowprogramming.com/docs/widgets/ScrollingMessageFrame/SetTimeVisible).
