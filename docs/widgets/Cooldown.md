...
[Source](https://web.archive.org/web/20100726120937/http://wowprogramming.com/docs/widgets/Cooldown)
...
```lua
Cooldown:IsJumpNavigateEnabled()
```
...
```lua
Cooldown:SetJumpNavigateEnabled()
```
