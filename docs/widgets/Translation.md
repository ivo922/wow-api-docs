...
[Source](https://web.archive.org/web/20100726120937/http://wowprogramming.com/docs/widgets/Translation)
...
```lua
framerate = Translation:GetMaxFramerate()
```
...
```lua
Translation:SetMaxFramerate(framerate)
```
