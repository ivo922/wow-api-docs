...
Determines whether [OnEnter](#onenter)/[OnLeave](#onleave) scripts will fire while the button is disabled
...
Sets whether the button should fire [OnEnter](#onenter)/[OnLeave](#onleave) events while disabled
