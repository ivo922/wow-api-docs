...
- `scroll` - Current horizontal scroll position (0 = at left edge, `frame:`[`GetHorizontalScrollRange()`](Frame.md#framegethorizontalscrollrange) = at right edge) (`number`)
...
- `scroll` - Current vertical scroll position (0 = at top edge, `frame:`[`GetVerticalScrollRange()`](Frame.md#framegetverticalscrollrange) = at bottom edge) (`number`)
